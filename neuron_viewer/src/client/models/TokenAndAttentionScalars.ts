 ...
 * camelCase names.
 */
export type TokenAndAttentionScalars = {
  token: string;
  scalars: Array<number>;
  normalizedScalars: Array<number>;
  totalScalarIn: number;
  normalizedTotalScalarIn: number;
  maxScalarIn: number;
  normalizedMaxScalarIn: number;
  totalScalarOut: number;
  normalizedTotalScalarOut: number;
  maxScalarOut: number;
  normalizedMaxScalarOut: number;
};
