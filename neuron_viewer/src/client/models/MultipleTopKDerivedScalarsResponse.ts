...
import type { InferenceAndTokenData } from "./InferenceAndTokenData";
 ...
 * camelCase names.
 */
export type MultipleTopKDerivedScalarsResponse = {
  inferenceAndTokenData: InferenceAndTokenData;
  multipleTopKDerivedScalarsResponseData: MultipleTopKDerivedScalarsResponseData;
};
